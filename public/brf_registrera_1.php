<?php
SvenskBRF_Session::getInstance()->sortSavedAddresses();
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="wrapper" style="min-height: <?php if (!$bIsFromAdmin): ?>1200<?php else: ?>1200<?php endif; ?>px;">
            <form action="<?php echo BASE_DIR; ?>registrera/2" method="post" enctype="multipart/form-data" id="form">
                <div id="left">

                    <?php if (!$bIsFromAdmin): ?>   
                        <?php echo getHeaderPicture("<b style=\"font-weight: bold;\">1</b>/3. Antal lägenheter och", "föreningens adresser"); ?>
                    ...
                    <table width="330">
                        <?php if (!$bIsFromAdmin): ?>
                            ...
                            <tr>
                                <td width="320">
                                    <p>
                                        ...
                                        Här registrerar du, i några enkla steg, din förening på Svensk Brf - helt kostnadsfritt. 
                                        <!--Som sagt så är det helt kostnadsfritt.-->

                                        <!--Här registrerar du, i några enkla steg, din förening på Svensk Brf. Du behöver inte göra allt på en gång. *-->
                                    </p>
                                </td>
                            </tr>
                            ...
                            <?php /* $oPictures = $oBrf->getFrontPictures(); ?>
                              ...
                              <p>Börja med att ladda upp några fina bilder på din förening (här kan ni ladda upp fyra bilder). Bilderna kommer sedan att visas i bildspelet på föreningens publika sida. Ni kommer även kunna ladda upp ett obegränsat antal bilder i föreningens bildarkiv som endast kan nås av medlemmarna. Detta görs på styrelsens adminsida när du är klar med denna registreringsprocess.<br /><br /></p>
                            ...
                            <td style="background-color:#fff;" width="530">
                                <?php if (!$bIsFromAdmin): ?>
                                    ...
                                    <p style="font-size:11px;">
                                        <i>
                                             Obligatorisk uppgift för att kunna registrera rätt lägenheter i föreningen
                                        </i>
                                    </p>
                                <?php endif; ?>
                                <?php
                                ...
                                ?>
                                <p><b style="font-size: 14px;">FÖRENINGENS ADRESS:</b><!--Postadress (Detta är den som bolagsverket har registrerat)--></p>
                                ...
                                <p>&nbsp;</p>
                                <p><b style="font-size: 14px;">YTTERLIGARE ADRESSER:</b><!--Postadress (Detta är den som bolagsverket har registrerat)-->
                                &nbsp;<a href="javascript:void(0)" onclick="$('#addressesInstruction').fadeIn(); $(this).remove(); return false;">Läs mer</a>
                                </p>
                                
                                <div id="addressesInstruction" style="display:none;">
                                ...
                                <?php $bNoAddress = FALSE; ?>
                                    <p class="brfAddress">
                                        <i><?php echo $oBrf->formatBrfAddress($oBrfAddress); ?></i><br />
                                ...
                                <?php endforeach; ?>
                                    ...
                                    <?php endfor; ?>
                                <?php endif; ?>
                                <p id="noAddressP" style="color: grey;<?php if (!$bNoAddress): ?> display:none;<?php endif; ?>"><i>Inga adresser tillagda</i></p>
                                <p>&nbsp;</p>
                    ...
                    <table width="330">
                        <tr>
                            ...
                            <td width="200">
                                ...
                                <?php else: ?>
                                    <a href="javscript:void(0)" onclick="document.location.href='<?php echo BASE_DIR; ?>aktivera/<?php echo $oBrf->getUrl(); ?>'; return false;"><input type="image" src="<?php echo BASE_DIR; ?>media/registrera/img/ga_tillbaka.png" alt="Tillbaka" style="border:none;width:89px;height:35px;"/></a>
                                <?php endif; ?>
                        ...
                        <tr>
                            <td colspan="2">
                                <p style="font-size: 11px;">
                                    <i>
                                        * Så fort du trycker på <?php if (!$bIsFromAdmin): ?>&quot;Gå vidare&quot;<?php else: ?>&quot;Till styrelseadmin&quot;<?php endif; ?> sparas allt du fyllt i och du kan när som helst gå tillbaka och ändra dina inställningar (om du vill återkomma senare till registreringsprocessen – klicka på länken i mejlet som skickats till din mejladress).
                                    </i>
                                </p>
                            </td>
                        </tr>
                ...
                <div id="right">
                    <img class="hoger_bild" src="<?php echo BASE_DIR; ?>media/registrera/img/hoger_bild1.png" style="width: 451px; height: 564px; display:none;"/>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                setHeight(10 * (<?php echo count(SvenskBRF_Session::getInstance()->getSavedAddresses()) + $oBrf->getBrfAddresses()->size(); ?>));
                                ...
                                if (firstAddress == 0) {
                                    ...
                                    if (isSessionAddress == 0) {
                                        ...
                                        if (saveAddressIndex > -1) {
                                            ...
                                            $(p).after(
                                                    "<p class=\"sessionAddress\"><i> " + response.address + " </i><br />" +
                ...
                <?php if (strpos(@$_SERVER['HTTP_REFERER'], "aktivera/" . $oBrf->getUrl())): ?>
                //window.setTimeout('showMessage("Du får snart ett mejl med en länk till registreringsprocessen som du när som helst kan trycka på för att komma tillbaka till det steg du slutade på.", "OK")', 1000);   
                <?php endif; ?>
            });
        </script>
    </body>
