...
class PresidentLog extends DomainObject 
{
    ...
    /**
     * PresidentLog's 'archive' property. 
     *
     * @var bool
     */
    private $_bArchive;
    ...
    /**
     * Get PresidentLog's 'archive' property. 
     *
     * @return bool
     */
    function getArchive()
    ...
    /**
     * Set PresidentLog's 'archive' property. 
     *
    ...
    public static function create($a_iBrfId, $a_iCreatedByUserId, $a_iDocumentId, $a_sComment, $a_sDate, $a_iPresidentLogCategoryId, $a_sLogName, $a_sHeader, $a_bArchive, $a_bInstantCreation = FALSE)
    {
