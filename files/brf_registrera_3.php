                    ...
                    <table width="325"> 
                        <tr>
                            ...
                            <td style="background-color:#fff;padding-top:0px;" id="yearChooser" valign="top">
                                ...
                                <?php else: ?>
                                <inpu type="hidden" name="documentType" value="9"/>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" width="300">
                                ...
                                <?php if ($sStepParameter != 's'): ?><p style="font-size: 11px;"><input type="checkbox" id="public" name="public" value="1"/>Bocka i rutan om dokumentet är offentligt. Ett offentligt dokument visas även för dem som inte är inloggade på sidan.</p><?php else: ?><p>&nbsp;</p><?php endif; ?>
                        ...
                        <tr>
                            <td width="300" style="background-color:#fff; padding-top:20px; padding-bottom:20px;">
                                ...
                                <ul>
                                    <?php $iHeight = 0; ?>
                                    <?php
                                        $oDocumentTypes = $oBrf->getDocumentTypes($sStepParameter === 's'); 
                                    ?>
                                    <?php foreach ($oDocumentTypes as $oDocumentType): ?>
                                    <?php $iHeight += 15; ?>
                                    <?php $oDocuments = $oBrf->getDocuments($oDocumentType->getId(), $sStepParameter === 's'); ?>
