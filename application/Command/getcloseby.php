...
/**
 * Description of getcloseby
 *
 * @author John Jansson
 */
class Command_getcloseby extends Command_loadhtmlcommand
{
     ...
     * @return array
     */
    protected function _executeCommand1() 
    {
        $aBranches = array(
            ...
            //108 => array('exclude' => array()), // bad
            //86  => array('exclude' => array()), // bibliotek
        );
        extract($this->_aRequest);
